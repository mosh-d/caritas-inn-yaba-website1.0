...
export default function AvailableRoomsSection() {
  ...
  // Room-type names in the DB inconsistently include/omit the "Suite"
  // suffix, so both forms are mapped here for a safe lookup regardless.
  ...
  const mobileRoomGalleryImages = {
    ...
    "Executive Suite": mobileExecutiveImages,
  ...
  const mobileRoomTypeImages = {
    ...
    "Executive Suite": mobileExecutiveImage,
